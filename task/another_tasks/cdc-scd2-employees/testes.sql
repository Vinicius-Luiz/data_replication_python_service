...
-- INSERT 
SELECT * FROM employees.salary WHERE employee_id IN (500000, 500001, 500002) ORDER BY employee_id;
...
SELECT * FROM employees.department_manager WHERE employee_id IN (500000, 500001, 500002);
