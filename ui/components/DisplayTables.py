...
class DisplayTables:
    ...
    def render(self):
        ...
        st.markdown(
            """
            Configure as tabelas que serão replicadas do banco de dados de origem para o destino.
            Defina o schema, nome da tabela e a prioridade de processamento de cada uma.
            A prioridade determina a ordem em que as tabelas serão processadas.
            """
        )
